...
export class AmenazasComponent {
  ...
  terminarRoute(){
    ...
    if(this.amenazas1 !== null && this.amenazas1 !== ""){
      this.flag = parseInt(this.flag.toString(), 10) + 1;
    }
    if(this.amenazas2 !== null && this.amenazas2 !== ""){
      this.flag = parseInt(this.flag.toString(), 10) + 1;
    }
    if(this.amenazas3 !== null && this.amenazas3 !== ""){
      this.flag = parseInt(this.flag.toString(), 10) + 1;
    }
    if(this.amenazas4 !== null && this.amenazas4 !== ""){
      this.flag = parseInt(this.flag.toString(), 10) + 1;
    }
      ...
      Swal.fire(
        {
          ...
          html: 'Por favor introduzca al menos 3 amenazas e intente nuevamente',
