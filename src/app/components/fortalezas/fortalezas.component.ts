...
export class FortalezasComponent {
  ...
  terminarRoute(){
    ...
    if(this.fortalezas1 !== null && this.fortalezas1 !== ""){
      this.flag = parseInt(this.flag.toString(), 10) + 1;
    }
    if(this.fortalezas2 !== null && this.fortalezas2 !== ""){
      this.flag = parseInt(this.flag.toString(), 10) + 1;
    }
    if(this.fortalezas3 !== null && this.fortalezas3 !== ""){
      this.flag = parseInt(this.flag.toString(), 10) + 1;
    }
    if(this.fortalezas4 !== null && this.fortalezas4 !== ""){
      this.flag = parseInt(this.flag.toString(), 10) + 1;
    }
      ...
      Swal.fire(
        {
          ...
          html: 'Por favor introduzca al menos 3 fortalezas e intente nuevamente',
