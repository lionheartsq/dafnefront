...
export class PerfilesComponent {
  ...
  guardarRoute(){
    const varMensaje = {perfil:this.perfil, precio:this.precio, idUsuario:parseInt(this.idUsuarioCargado)};

    this.utilsService.crearPerfil(varMensaje).subscribe((data)=>{
      Swal.fire(
        {
          icon: 'success',
          title: 'Solicitud enviada',
          text: 'Perfil empresa creado correctamente',
          footer: data.message
        }
      ).then(() => {
        //
