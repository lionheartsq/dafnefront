...
export class DebilidadesComponent {
  ...
  terminarRoute(){
    ...
    if(this.debilidades1 !== null && this.debilidades1 !== ""){
      this.flag = parseInt(this.flag.toString(), 10) + 1;
    }
    if(this.debilidades2 !== null && this.debilidades2 !== ""){
      this.flag = parseInt(this.flag.toString(), 10) + 1;
    }
    if(this.debilidades3 !== null && this.debilidades3 !== ""){
      this.flag = parseInt(this.flag.toString(), 10) + 1;
    }
    if(this.debilidades4 !== null && this.debilidades4 !== ""){
      this.flag = parseInt(this.flag.toString(), 10) + 1;
    }
      ...
      Swal.fire(
        {
          ...
          html: 'Por favor introduzca al menos 3 debilidades e intente nuevamente',
